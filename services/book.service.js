...
//     if (!books || !books.length){
//         books=[]
//         books.push(_createBook("metus hendrerit",utilService.makeLorem(155),
//         {amount:109,currencyCode:'USD', isOnSale:false}))
//         books.push(_createBook("Lula Marsh",utilService.makeLorem(300),
//         {amount:526,currencyCode:'JPY', isOnSale:false}))
//         books.push(_createBook("Rabbit Run",utilService.makeLorem(200),
//         {amount:855,currencyCode:'EUR', isOnSale:false}))
//         utilService.saveToStorage(DB_KEY, books)
//     }
// }
